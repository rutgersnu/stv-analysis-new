...
//      std::cout << element << std::endl;
  ...
  for ( int a = 0; a < num_bins; ++a ) {
    for ( int b = 0; b < num_bins; ++b ) {
      ...
      std::cout << "element: " << element << ", expected_element: " << expected_element << ", original_element: " << orig_element << std::endl;
      if ( abs_diff > inversion_tolerance ) {
        std::cout << "abs_diff: " << abs_diff << std::endl;
        std::cout << "inversion_tolerance: " << inversion_tolerance << std::endl;
