...
//      auto& mat_ref = err_prop_mc_vec.emplace_back( num_ordinary_reco_bins, num_true_signal_bins );
      err_prop_mc_vec.emplace_back( num_ordinary_reco_bins, num_true_signal_bins );
