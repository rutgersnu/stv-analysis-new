...
class AnalysisEvent {
  ...
  public:
    ...
    bool sel_pions_above_threshold_ = false;
    ...
    bool sel_pions_contained_ = false;
  ...
  bool create = false)
{
  ...
  set_output_branch_address( out_tree, "sel_pions_contained",
    &ev.sel_pions_contained_, create, "sel_pions_contained/O" );
  ...
  set_output_branch_address( out_tree, "sel_pions_above_threshold",
    &ev.sel_pions_above_threshold_, create, "sel_pions_above_threshold/O" );
